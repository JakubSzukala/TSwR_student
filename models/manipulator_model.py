...
class ManiuplatorModel:
    def __init__(self, Tp):
        ...
        # Add d* lengths for convinience
        self.d1 = self.l1/2
        self.d2 = self.l2/2

        # Add parameters of a matrixes
        ...
        self.phi = self.l1 * self.l2 * self.m3
        self.gamma = self.m2 * self.d2**2 + self.I_2 + self.m3 * self.l2**2 + \
                self.I_3

    def M(self, x):
        """
        Please implement the calculation of the mass matrix, 
        according to the model derived in the exercise
    ...
    def C(self, x):
        """
        Please implement the calculation of the Coriolis and centrifugal 
        forces matrix, according to the model derived
